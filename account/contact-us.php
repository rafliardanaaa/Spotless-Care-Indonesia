            ...
            <div class="bg-white p-8 shadow-md rounded-lg">
                <div class="bg-teal-500 px-8 py-6 rounded-lg">
                    ...
                    <div class="text-white flex justify-between">
                        <p>Semua ketentuan yang terkait dengan Spotless & Care Indonesia</p>
                    </div>               
                </div>
                <div class="mt-8 px-4">
                    <div class="flex justify-between my-6">
                        <h1 class="font-semibold text-lg">WhatsApp ( 0878 6402 7655 )</h1>
                        <div class="font-semibold underline hover:text-teal-500">
                            <a href="https://wa.me/+6287864027655" class="">
                                <div class="">Kirim Pesan</div>
                            </a>
                        </div>
                    </div>
                    <div class="flex justify-between my-6">
                        <h1 class="font-semibold text-lg">Email ( support@spotlessandcareid.com )</h1>
                        <div class="font-semibold underline hover:text-teal-500">
                            <a href="mailto:support@spotlessandcareid.com" class="">
                                <div class="">Kirim Pesan</div>
                            </a>
                        </div>
                    </div>
