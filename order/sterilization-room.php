        ...
        <div class="grid grid-rows-1 grid-cols-2 gap-32">
            <div class="p-8 shadow-md rounded-xl">
                <div class="text-center font-bold text-2xl">
                    <h1>Sterilization Room</h1>
                </div>
                <div class="my-8">
                    <img class="rounded-lg" src="../img/mie.jpg" alt="">
                </div>
                <div class="text-justify">
                    <p>Layanan penyemprotan ruangan dengan cairan sterilisasi yang aman untuk manusia dan membantu untuk membunuh kuman dan bakteri. KliknClean menggunakan alat khusus ULV yang menjamin semprotan akurat, jangkauan yang jauh dan terdistribusi dengan baik. Ruangan setelah dilakukan sterilisasi tidak dapat digunakan selama 1 jam.</p>
                </div>
            </div>
            <div class="p-8 shadow-md rounded-xl">
                ...
                <div class="grid grid-rows-1 grid-cols-2">
                    <div class="">
                        <p class="my-3">Jenis Paket</p>
                        <p>Jadwal Pengerjaan</p>
                        <p class="my-3">Catatan</p>
                        <p>Metode Pembayaran</p>
                    </div>
                    <div class="">
                        <p class="my-3">Paket F (601-700m2)</p>
                        <p>30/10/2023</p>
